    ...
    axios
      ...
      .then((res) => {
        ...
        if (res.data.user?.type === "visitor") {
          setLoading(false);
        } else if (res.data.user?.accessId === 3) {
          navigate("/admin");
      ...
      <div className="shadow-xl flex max-w-4xl mx-auto rounded-xl">
        <section className="bg-[#f2f2f2] p-8 w-[50%] rounded-tl-xl rounded-bl-xl flex flex-col gap-4">
          ...
          <div className="font-bold text-xl">
            Application de Pointage d'Entrée et Gestion des Congés
          </div>
          <div className="flex flex-col gap-2">
            <div>
              {" "}
              ✓ Suivi avancé du <span className="font-semibold">
                Temps
              </span>{" "}
            ...
            <div>
              ...
              <span className="font-semibold">
                Calendrier, aux Notifications et aux Rapports
              </span>{" "}
            </div>
            ...
            <div>
              ...
              <span className="font-semibold">intuitive</span> pour une
              navigation fluide{" "}
            </div>
            ...
            <div>
              {" "}
              ✓ Utilisation de{" "}
              <span className="font-semibold">Widgets Personnalisés</span> et de{" "}
              <span className="font-semibold">Tableaux de Bord sur Mesure</span>{" "}
            </div>
          </div>
        </section>
        <form
          className="flex flex-col p-8 gap-4 w-[50%] justify-center"
        ...
        >
          <div className="flex flex-col gap-4">
            ...
            <Link
              className="text-indigo-600 text-end"
            ...
            <button
              type="submit"
              className="self-center w-full bg-indigo-600 hover:bg-indigo-800 rounded-xl py-3 text-white font-bold"
            >
              Login
            </button>
          </div>
